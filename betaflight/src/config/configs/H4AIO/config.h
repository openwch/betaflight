...
#define BOARD_NAME                          H4AIO
#define MANUFACTURER_ID                     DEMO

// #define USE_INTERNAL_OSD                 //使用内置OSD
...
#else
#define USE_PINIO
#define CAM_SWITCH                          PA12
#define PINIO1_PIN                          PA11
#define PINIO2_PIN                          CAM_SWITCH
